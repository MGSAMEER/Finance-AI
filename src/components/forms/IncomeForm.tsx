...
import { incomeInputSchema, type IncomeInput } from "@/lib/schemas";
...
export function IncomeForm() {
  ...
  const form = useForm<IncomeInput>({
    resolver: zodResolver(incomeInputSchema) as Resolver<IncomeInput>,
    defaultValues: {
      type: "income",
      amount: 0,
      category: "Other",
  ...
  const onSubmit = async (values: IncomeInput) => {
    ...
    toast({ title: "Income saved", description: "Your income was added." });
    router.push("/");
  };
